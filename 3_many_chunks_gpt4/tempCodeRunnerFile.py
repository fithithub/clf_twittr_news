...
This means there must be the same number of tweets as rows returned.
Here are the tweets:
"""
...
for chunk in chunks:
    ...
    print("Expected output tokens: ", 40*chunk.count('\n'))
    print("Original num tweets: ", chunk.count('\n'),". Obtained num tweets: ", response.count('\n')+1) # for response n breaks -> n+1 tweets. not for chunk
